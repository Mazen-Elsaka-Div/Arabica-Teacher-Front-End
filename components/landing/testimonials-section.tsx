...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    quote: 'المنصة غيّرت علاقتي باللغة العربية تمامًا، بقيت أفهم قواعد النحو وأطبّقها بسهولة. جبت أعلى درجة في حياتي في الإنشاء!',
    before: 42,
    after: 96,
    journey: [
  ...
  },
  {
    ...
    quote: 'طريقة الشرح بسيطة جدًا والاختبارات بعد كل درس بتثبّت المعلومة. البلاغة بقت أسهل حاجة عندي في اللغة العربية.',
    before: 55,
    after: 94,
    journey: [
      ...
      { month: 'مارس', score: 91 },
      { month: 'الامتحان', score: 94 },
    ],
  },
  {
    name: 'حبيبة محمود',
    grade: 'الأول الثانوي',
    subject: 'الإعراب والتحليل',
    quote: 'المنصة منظمة وكل المواد مرتبة، بحس إن فيه حد ماسكني خطوة بخطوة لحد الامتحان. الإعراب بقى واضح ومنطقي.',
    before: 48,
    after: 97,
    journey: [
  ...
  return (
    <div className="grid h-full grid-cols-1 gap-px overflow-hidden rounded-[2rem] border border-navy/15 bg-navy/15 shadow-2xl shadow-navy/10 lg:grid-cols-5 dark:border-white/10 dark:bg-white/5 dark:shadow-black/40">
      ...
      >
            ...
            >
              <defs>
                <linearGradient id="scoreFill" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#c9a55c" stopOpacity={0.35} />
              ...
              <Line
                ...
                stroke="#c9a55c"
                strokeWidth={3}
                dot={{ r: 3, fill: '#4a3826', stroke: '#c9a55c', strokeWidth: 2 }}
                activeDot={{ r: 6, fill: '#c9a55c' }}
                isAnimationActive
        ...
        <div
          className={cn(
            'flex items-center justify-center gap-4 font-heading',
            compact ? 'mt-4' : 'mt-6',
          )}
        >
          <div className="text-center">
            <span className="block text-xs text-cream/50 dark:text-ink-dim">قبل</span>
            <span className={cn('font-bold text-red-400', compact ? 'text-xl' : 'text-2xl')}>
        ...
        {items.map((_, i) => (
          <button
            ...
            className={cn(
              ...
              i === index ? 'w-6 bg-gold dark:bg-teal-glow' : 'w-2 bg-navy/20 dark:bg-white/20',
            )}
          />
        ))}
      </div>
      ...
      <div className="sticky top-20 flex min-h-[calc(100vh-5rem)] w-full flex-col justify-center pb-12 pt-4">
        <div className="mx-auto w-full max-w-7xl px-8">
          <div className="reveal-item mx-auto mb-6 max-w-4xl text-center md:mb-10">
            ...
            <h2 className="font-heading font-bold mt-3 text-3xl leading-tight text-navy sm:text-4xl lg:text-5xl dark:text-ink-fg">
              قصص نجاح حقيقية
            </h2>
            <p className="mt-4 text-pretty text-lg leading-relaxed text-ink-muted dark:text-ink-dim">
              أرقام ومنحنيات حقيقية تحكي رحلة كل طالب من نقطة البداية إلى التفوق.
            </p>
          </div>
          <div className="reveal-item">
    ...
    <section ref={root} id="testimonials" className="relative">
      ...
      <div className="mx-auto w-full max-w-2xl px-5 py-12 md:hidden">
        <div className="mx-auto mb-6 max-w-4xl text-center">
          ...
          <h2 className="font-heading font-bold mt-3 text-3xl leading-tight text-navy sm:text-4xl dark:text-ink-fg">
            قصص نجاح حقيقية
          </h2>
          <p className="mt-4 text-pretty text-lg leading-relaxed text-ink-muted dark:text-ink-dim">
            أرقام ومنحنيات حقيقية تحكي رحلة كل طالب من البداية إلى التفوق.
          </p>
        </div>
