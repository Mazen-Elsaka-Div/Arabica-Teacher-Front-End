...
/* كارت تقييم واحد: منحنى تقدّم + قبل/بعد + اقتباس */
...
/* موبايل: كاروسيل سحب حقيقي بـ CSS scroll-snap */
...
/* ديسكتوب: عرض ثابت يتبدّل مع السكرول */
...
export function TestimonialsSection() {
  ...
  return (
    <section ref={root} id="testimonials" className="relative bg-background">
      ...
      {/* ديسكتوب / تابلت: العرض المتحرك مع السكرول */}
